...
describe('Test suite: Course and Lecture testing', function () {
  ...
  let testCourse1 // eslint-disable-line
  ...
  describe('Test for adding and deleting admins from course: ' + courseCode4, function () {
    ...
    let testAdminRole1 // eslint-disable-line
    let testAdminRole2 // eslint-disable-line
  ...
  let courseAdmins5 // eslint-disable-line

  describe('Test for getting a course: ' + courseCode5, function () {
    let testCourse5 // eslint-disable-line
  ...
  let courseAdmins6 = ['me'] // eslint-disable-line
  ...
  describe('Test for getting all lectures for a course: ' + courseCode6, function () {
        ...
        .spread(function (course, created) {
          ...
          lectureController.createLecture({
            ...
            .then(function (lecture, created) {
              testLecture6v1 = lecture
              lectureController.createLecture({
                name: 'Turing Machines Part 2',
                CourseId: testCourse6.id
              }).then(function (lecture) {
                testLecture6v2 = lecture
                done()
              })
            })
        })
    ...
    it('Lectures are retrieved successfully', function (done) {
      courseController.getAllLecturesForCourse(courseCode6, function (lectures) {
        ...
        if (lecture1.name === testLecture6v1.name) {
          // assert.equal(lecture1.admins, testLecture6v1.admins)
          assert.equal(lecture2.name, testLecture6v2.name)
        } else {
          // assert.equal(lecture2.admins, testLecture6v1.admins)
          assert.equal(lecture1.name, testLecture6v2.name)
        }
    ...
    after(function (done) { // eslint-disable-line
      testLecture6v1.destroy().then(function () {
        testLecture6v2.destroy().then(function () {
